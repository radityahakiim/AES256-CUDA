...
__global__ void AES256EncryptBlockECB(uint8_t* plaintext, const uint8_t* expandedKey, int numBlocks);
void AES256EncECBMode(const std::vector<uint8_t>& plaintext, const uint8_t* key, std::vector<uint8_t>& ciphertext);
#endif // AES_CUH
